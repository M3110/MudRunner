    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddSwaggerDocs(this IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                var xmlApiPath = Path.Combine(AppContext.BaseDirectory, "MudRunner.Suspension.Application.xml");
                var xmlDataContractPath = Path.Combine(AppContext.BaseDirectory, "MudRunner.Suspension.DataContracts.xml");
