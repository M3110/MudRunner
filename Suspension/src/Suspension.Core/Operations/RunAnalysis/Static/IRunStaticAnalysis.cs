...
namespace MudRunner.Suspension.Core.Operations.RunAnalysis
{
        ...
        where TProfile : Profile
    {
        ...
        /// <param name="decimals"></param>
        /// <returns></returns>
        Task<SuspensionAArmStaticAnalysisResult> GenerateSuspensionAArmResultAsync(SuspensionWishbone<TProfile> component, bool shouldRoundResults, int decimals = 0);
    }
}
